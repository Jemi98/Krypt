    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex md:flex-row  flex-col justify-between md:p-20 py-12 px-4 ">
        <div className="flex flex-1 justify-start flex-col md:mr-10  text-white">
          <h1 className=" text-3xl sm:5xl text-gradient py-1">
            Send Crypto <br /> cross the world
          </h1>
          <p className="text-left mt-5  font-light md:w-9/12 w-11/12 text-base ">
            Explore the crypto worls. Buy and sell cryptocurrancies easily on
            Krypto
          </p>
          <button
            type="button"
      ...
      <div className="flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10 ">
        <div className="p-3 justify-end items-start flex-col rounded-xl  h-40 sm:w-72 w-full my-5 eth-card white-glasmorphism">
          <div className="flex justify-between flex-col w-full h-full">
            ...
            <div>
              <p className="text-white font-light text-sm">0xsdffe....wde42</p>
